...
I believe the answer is yes -- while the attacker messed with the Boot Configuration Data (BCD) store, which determines how the OS starts, it doesn't appear the disks were actually encrypted on the user workstations or the domain controller!](https://aceresponder.com/challenge/locked-up
